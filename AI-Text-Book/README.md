...
An open-source interactive textbook platform for learning Physical AI and Humanoid Robotics using Docusaurus 3, React 18, and TypeScript.
...
- **Frontend Framework**: Docusaurus 3.x with React 18.x
...
1. **Frontend-Only MVP**: All data persisted to localStorage; backend optional in Phase 2
2. **Static Site Generation**: Docusaurus provides built-in SEO, performance, and i18n
3. **CSS Variables Design System**: Consistent theming across all components
4. **Service-Oriented Architecture**: Clear separation of concerns with services
5. **Context API for State**: Minimal dependencies for global state management
...
**Status**: Phase 1 (Setup & Infrastructure) - In Progress
